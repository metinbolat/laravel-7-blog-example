...
<div class="content-wrapper">
  ...
  <section class="content container-fluid">
    <div class="box box-primary">
      ...
      <div class="box-body">
        <x-alert />
        <form action="{{route('post_update',$postId->id)}}" method="post" enctype="multipart/form-data">
          @csrf
                ...
                <div class="col-md-3">
                    <div class="bootstrap-timepicker">
                        ...
                        <div class="input-group">
                            <input value="{{$postId->created_at->format('H:i')}}" type="text" class="form-control timepicker" name="time">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-md-6">
                    ...
                    <select name="categories[]" id="category" class="form-control select2 select2-hidden-accessible" multiple="" data-placeholder="Select Categories" style="width: 100%;" tabindex="-1" aria-hidden="true">
                        @foreach($categories as $category)
                            <option value="{{$category->id}}"
                                    @foreach($postId->categories as $postCategory)
                ...
                <div class="col-md-3">
                    ...
                    <select name="tags[]" id="category" class="form-control select2 select2-hidden-accessible" multiple="" data-placeholder="Select Tags" style="width: 100%;" tabindex="-1" aria-hidden="true">
                        @foreach($tags as $tag)
                            <option value="{{$tag->id}}"
                            @foreach($postId->tags as $postTag)
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <label>Image</label>
                <input class="form-control" type="file" name="post_file" value="">
              </div>
              <div class="col-md-3">
