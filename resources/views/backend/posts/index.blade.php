                        ...
                        <div class="box-header">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="home-tab"  href="{{route('post_index')}}" role="tab" aria-controls="home" aria-selected="true">All ({{$countAll}})</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="profile-tab"  href="{{route('post_my')}}" role="tab" aria-controls="profile" aria-selected="false">My ({{$countAu}})</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="messages-tab" href="{{route('post_pub')}}" role="tab" aria-controls="messages" aria-selected="false">Published ({{$countPub}})</a>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach ($posts as $post)
                                    <tr>
                                        ...
                                        <td width="5"><a href="{{route('post_edit',$post->id)}}"><button class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></button></a></td>
                                ...
                                @endforeach
                                <div class="col-md-12"><ul class="pagination pagination-sm no-margin pull-left">{!! $posts->links() !!}</ul></div>
                            </table>
