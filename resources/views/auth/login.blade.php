...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="/backend/assets/plugins/iCheck/square/blue.css">
  ...
  <div class="login-box-body">
    ...
    <form action="{{ route('login') }}" method="post">
      ...
      <div class="form-group has-feedback">
        <input class="form-control" placeholder="{{ __('Username') }}" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
